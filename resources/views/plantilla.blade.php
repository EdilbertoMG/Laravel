...
<html class="no-js">
    <head>
        ...
        <title>Edilberto M. Gutiérrez</title>
                ...
                <div class="container">
                    <div class="col-md-8">
                        <p class="copyright">Copyright: <span><script>document.write(new Date().getFullYear())</script></span> Design and Developed by <a href="http://www.Themefisher.com" target="_blank">Themefisher</a>. <br> 
                            Get More 
                            <a href="https://github.com/EdilbertoMGutierrez/my-app-laravel" target="_blank" class="Github">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="social">
                            <li>
                                <a href="https://www.facebook.com/EdilbertoMGutierrez" class="Facebook">
                                    <i class="ion-social-facebook"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/Edil_Gutierrez" class="Twitter">
                                    <i class="ion-social-twitter"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/in/edilbertomgutierrez/" class="Linkedin">
                                    <i class="ion-social-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://plus.google.com/u/0/104829863529448971223" class="Google Plus">
